...
def epex_pl(scrap_date):
    ...
    print(df)
    df.to_excel(f"C:/Users/{os.environ['USERNAME']}/Documents/pyData/epex/{scrap_date}_PL.xlsx")
...
def epex_de(scrap_date):
    ...
    print(df)
    df.to_excel(f"C:/Users/{os.environ['USERNAME']}/Documents/pyData/epex/{scrap_date}_DE.xlsx")
